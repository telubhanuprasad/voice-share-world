      ...
      <div className="flex-1 flex items-center justify-center bg-whatsapp-chat-bg">
        <div className="text-center">
          <div className="w-64 h-64 mx-auto mb-8 opacity-20">
            <svg viewBox="0 0 303 172" width="360" height="200" className="text-muted-foreground fill-current">
          ...
          <h2 className="text-2xl font-light text-muted-foreground mb-2">WhatsApp Web</h2>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 relative">
            <Input
              ...
              className="bg-secondary border-none focus:ring-1 focus:ring-primary pr-12"
            />
          </div>
          <Button
            onClick={handleSendMessage}
            size="sm"
            className="bg-whatsapp-green hover:bg-whatsapp-green-light text-primary-foreground"
        ...
        <div className={`flex items-center justify-end mt-1 space-x-1 ${
          ...
          {message.isSent && (
            <div className="flex">
              ...
              {message.status === 'read' && (
                <svg width="16" height="12" viewBox="0 0 16 12" className="fill-whatsapp-green">
                  <path d="M11.1 2.7L5.5 8.3l-2.6-2.6L1.5 7.1l4.0 4.0 7.0-7.0z" />
                  <path d="M15.1 2.7L9.5 8.3l-1.6-1.6 1.4-1.4 2.2 2.2 4.2-4.2z" />
                </svg>
              )}
