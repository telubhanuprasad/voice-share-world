...
export const ChatSidebar = ({
  ...
  // Create contacts list with chat data
  const contacts = users.map(user => {
    ...
    if (a.hasChat !== b.hasChat) return b.hasChat ? 1 : -1;
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-1">
            <Button
              variant="ghost"
              size="icon"
              className="text-muted-foreground hover:bg-whatsapp-header/50 hover:text-foreground"
        ...
        {loading ? (
          ...
          <div className="flex items-center justify-center p-8">
            <div className="text-muted-foreground text-center">
              <p>No users found</p>
              <p className="text-sm mt-1">Other users will appear here once they join</p>
            </div>
          </div>
        ) : (
          contacts.map((contact) => (
            <div
              ...
              className={`p-4 cursor-pointer transition-colors hover:bg-message-hover border-b border-border/30 ${
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    ...
                    {contact.unreadCount > 0 && (
                      <span className="bg-whatsapp-green text-white text-xs rounded-full px-2 py-0.5 min-w-[18px] h-4 flex items-center justify-center">
                        {contact.unreadCount}
                      </span>
                    )}
                  </div>
